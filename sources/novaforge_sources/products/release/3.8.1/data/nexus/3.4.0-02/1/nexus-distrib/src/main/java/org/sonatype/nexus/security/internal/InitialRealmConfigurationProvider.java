...
public class InitialRealmConfigurationProvider implements Provider<RealmConfiguration> {
	...
	public RealmConfiguration get() {
		...
		configuration.setRealmNames(Lists.newArrayList(CasTokenAuthenticatingRealm.NAME, NovaForgeRealmImpl.NAME,
				AuthenticatingRealmImpl.NAME, AuthorizingRealmImpl.NAME));
