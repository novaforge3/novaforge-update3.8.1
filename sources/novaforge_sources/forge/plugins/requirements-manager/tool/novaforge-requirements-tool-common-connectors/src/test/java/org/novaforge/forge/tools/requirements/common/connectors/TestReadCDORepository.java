...
public class TestReadCDORepository extends TestCase
{
  ...
  private String host                      = "localhost";
   ...
   private String  repository                = "designer-server";
   
   private String  repositoryUri                = "LibrairieVirtuelle/LibrairieVirtuelle.requirement";
   ...
   public void testRead()
   {
      if (testCDOconnectorActivated)
      {
         ...
         try
         {
            ...
            final CDOResource resource = view.getResource(repositoryUri);
