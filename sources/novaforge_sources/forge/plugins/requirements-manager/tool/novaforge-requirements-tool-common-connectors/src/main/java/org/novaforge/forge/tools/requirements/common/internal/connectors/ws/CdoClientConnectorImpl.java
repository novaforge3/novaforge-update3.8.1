 ...
 *
 */
public class CdoClientConnectorImpl implements CdoClientConnector
{
  /**
   * HttpClient
   */
  ...
  /**
   * Base URL used to contact client
   */
  ...
  public CdoClientConnectorImpl (final URL pBaseUrl, final String pAdmin, final String pToken ){
