...
public class IterationListPresenter implements TabPresenter {
  ...
  private Logger logger = Logger.getLogger(IterationListPresenter.class.getName()); 
	...
	private void bind()
  {
    //handler on selection model
      view.getSelectionModel().addSelectionChangeHandler(
         ...
         public void onSelectionChange(SelectionChangeEvent event) {
           setCurrentIterationDTO(view.getSelectionModel().getSelectedObject());
         }
   ...
   public void fillIterationList() {
	...
	private void refreshIterationsList(List<IterationDTO> pList)
	{
	  view.getSelectionModel().clear();
	  resetSelectedIteration();
	  
	  iterationsList = new ArrayList<IterationDTO>();
	  iterationsList.addAll(pList);
	  view.getIterationsDataProvider().getList().clear();
	  view.getIterationsDataProvider().setList(iterationsList);
	  view.updateIterationsSortHandler();
	  view.getIterationsTable().redraw();
	}
	
	protected void setCurrentIterationDTO(IterationDTO iteration) 
	{  
